...
acoes = ["PETR4.SA", "VALE3.SA", "BBSE3.SA", "INBR32.SA",
         "ITUB4.SA", "PRIO3.SA", "M2ST34.SA"]
dados = carregar_dados(acoes)

st.sidebar.header("Filtros")

# Filtro de ações
lista_acoes = st.sidebar.multiselect("Escolha as ações para visualizar",
                                     dados.columns)
if lista_acoes:
...
if performance_carteira > 0:
    ...
    texto_performance_carteira = f"Performance da carteira com todos os ativos: [{performance_carteira:.2%}]"
